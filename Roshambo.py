...
while(1):
    ...
    user_choice = input("Make your choice (rock ,paper, scissors) or type 'Q' to exit the game : \n")
    computer_choice = random.choice(actions)
    if user_choice==computer_choice:
        print("It is a tie!!!")
    elif user_choice=='rock':
        if computer_choice=='paper':
            print(f"Computer chose : {computer_choice}. You lose !!! Better luck next time")
        else:
