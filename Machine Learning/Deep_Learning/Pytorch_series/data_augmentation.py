'''
Refer to the original blog for more info: https://pytorch.org/vision/stable/transforms.html
...
my_transforms = transforms.Compose(
    [  # Compose makes it possible to have many transforms
        ...
        transforms.RandomCrop((132, 132)),  # Takes a random (32,32) crop
...
test_dataset = datasets.CIFAR10(root="dataset/", train=False, transform=my_transforms, download=True)
